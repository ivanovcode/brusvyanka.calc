...
<article>
    <div class="in">        
        ...
        <div class="steps">
          <p><strong>Название:</strong> <i>[@title]</i></p>
          <p><strong>Артикул:</strong> <i>[@article]</i></p>
          <p><strong>Площадь:</strong> <i>[@area]</i></p>
          <p><strong>Количество комнат:</strong> <i>[@rooms]</i></p>
          <p><strong>Этажность:</strong> <i>[@floors]</i></p>
        </div>
